 ...
 */
@SuppressWarnings({"DuplicatedCode", "all"})
public class Vector implements Cloneable {
    ...
    public float angle(@NotNull Vector other) {
        double dot = constrainToRange(dot(other) / (length() * other.length()), -1.0, 1.0);
     ...
     */
    @NotNull
    public Location toLocation(@NotNull String world) {
     ...
     */
    @NotNull
    public Location toLocation(@NotNull String world, float yaw, float pitch) {
